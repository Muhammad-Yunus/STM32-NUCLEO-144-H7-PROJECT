...
void HAL_SAI_MspInit(SAI_HandleTypeDef* hsai)
{
  ...
  /* Peripheral clock enable (shared for SAI1 A and B) */
  if (SAI1_client == 0)
  {
  ...
  if(hsai->Instance==SAI1_Block_B)
  {
    ...
    */
    ...
    /* SAI1_B DMA Init (RX) */
    hdma_sai2_a.Instance = DMA1_Stream1;
    hdma_sai2_a.Init.Request = DMA_REQUEST_SAI1_B;
